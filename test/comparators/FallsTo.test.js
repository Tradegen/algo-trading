...
describe("FallsTo", () => {
  ...
  before(async () => {
    ...
    ComparatorFactory = await ethers.getContractFactory('TestFallsTo');
  ...
  describe("#checkConditions", () => {
    ...
    it("One update; starts below second indicator", async () => {
        ...
        let tx11 = await candlestickDataFeedRegistry.setPrice("BTC", 1, parseEther("800"));
        await tx11.wait();
    ...
    it("One update; starts above second indicator, falls too much", async () => {
        let tx = await ema.setKeeper(1, deployer.address);
        await tx.wait();
        ...
        let tx11 = await candlestickDataFeedRegistry.setPrice("BTC", 1, parseEther("1005"));
        await tx11.wait();
    ...
    it("One update; starts above second indicator, meets conditions", async () => {
        let tx = await ema.setKeeper(1, deployer.address);
        await tx.wait();
